...
@NgModule({
  declarations: [HomeComponent, HomeHeroComponent, HomeDetailsComponent, HomeTrustedBusinessesComponent, HomeSupportedBrandedComponent, HomeGlobalBrandComponent],
